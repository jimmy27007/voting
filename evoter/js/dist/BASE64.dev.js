...
!function (t, n) {
  var r, e;
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (r = t.Base64, (e = n()).noConflict = function () {
    return t.Base64 = r, e;
  ...
  var t,
    ...
    for (var n, r, e, o = "", u = 0; u < t.length;) {
      n = f[t.charAt(u++)] << 18 | f[t.charAt(u++)] << 12 | (r = f[t.charAt(u++)]) << 6 | (e = f[t.charAt(u++)]), o += 64 === r ? a(n >> 16 & 255) : 64 === e ? a(n >> 16 & 255, n >> 8 & 255) : a(n >> 16 & 255, n >> 8 & 255, 255 & n);
    }

    return o;
  },
      S = "function" == typeof atob ? function (t) {
    return atob(l(t));
  } : e ? function (t) {
    ...
    var t = function t(_t, n) {
      return Object.defineProperty(String.prototype, _t, Z(n));
    };
    ...
    var t = function t(_t2, n) {
      return Object.defineProperty(Uint8Array.prototype, _t2, Z(n));
    };
